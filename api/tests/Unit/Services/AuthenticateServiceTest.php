...
class AuthenticateServiceTest extends TestCase
{
    ...
    public function test_authenticate(): void
    {
        ...
        // テスト対象メソッドの実行
        $actual = $this->_authenticateService->authenticateAppUser($this->_user->email, $this->_password);
    ...
    public function test_authenticate_fail(): void
    {
        ...
        // テスト対象メソッドの実行
        $actual = $this->_authenticateService->authenticateAppUser($this->_user->email, $this->_password_wrong);
